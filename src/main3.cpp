...
int main(int argc, char **argv)
{
    ...
    mpi::environment env; /* MPI initialization, all the processes copy of the current variables */
    ...
    if (world.rank() == 0) {
        ...
        if(argc == 5
            ...
            transactions = read_file(argv[1], word_per_line); /* In this function is checked also the opening of the file */
